...
const plantVariant = {
  initial: { x: 0, y: 0, rotate: 0, originX: '50%', originY: '100%' },
  hover: {
    x: [0, -2, 2, -2, 0],
    y: [0, 2, -2, 2, 0],
...
export function Plant2({ className }: { className?: string }) {
  return (
    <motion.div
      initial="initial"
      whileHover="hover"
